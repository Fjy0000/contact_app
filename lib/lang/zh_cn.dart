const Map<String, String> zhCN = {
  ...
  "empty": "空",
  "confirm": "确认",
  "permission_required": "权限许可",
  "permission_required_camera": "需要开启相机权限才能继续",
  "permission_required_storage": "需要开启存储权限才能继续",
  "permission_required_phone": "需要开启通话权限才能继续",
  "no_app_state": "未指定应用程序状态",
  "refresh": "刷新",
  "retry": "重试",
